...
ipcMainUtils.handleSync('ELECTRON_GUEST_VIEW_MANAGER_CREATE_GUEST_SYNC', function (event, params) {
  assertWebViewTagEnabled(event)
  return createGuest(event.sender, params)
})
...
ipcMainUtils.handle('ELECTRON_GUEST_VIEW_MANAGER_ASYNC_CALL', function (event, guestInstanceId, method, args, hasCallback) {
...
ipcMainUtils.handleSync('ELECTRON_GUEST_VIEW_MANAGER_SYNC_CALL', function (event, guestInstanceId, method, args) {
  assertWebViewTagEnabled(event)
